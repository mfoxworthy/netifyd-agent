...
const nd_protos_t nd_protos = {
    ...
    { ND_PROTO_AJP, "AJP" },
    { ND_PROTO_AMQP, "AMQP" },
    { ND_PROTO_APPLE, "Apple" },
    { ND_PROTO_APPLE_ICLOUD, "Apple/iCloud" },
    { ND_PROTO_APPLE_ITUNES, "Apple/iTunes" },
    ...
    { ND_PROTO_GOOGLE_DUO, "Google/Duo" },
    { ND_PROTO_GOOGLE_MEET, "Google/Meet" },
    { ND_PROTO_GTP, "GTP" },
    { ND_PROTO_GUILDWARS, "Guildwars" },
    { ND_PROTO_H323, "H323" },
    { ND_PROTO_HALFLIFE2, "HalfLife2" },
    { ND_PROTO_HEP, "HEP" },
    { ND_PROTO_HOTSPOT_SHIELD, "HotspotShield" },
    { ND_PROTO_HTTP_CONNECT, "HTTP/Connect" },
    { ND_PROTO_HTTP_DOWNLOAD, "HTTP/DL" },
    { ND_PROTO_HTTP, "HTTP" },
    ...
    { ND_PROTO_SOULSEEK, "Soulseek" },
    { ND_PROTO_SPOTIFY, "Spotify" },
    { ND_PROTO_SSDP, "SSDP" },
    { ND_PROTO_SSH, "SSH" },
    { ND_PROTO_SSL_NO_CERT, "SSL/NC" },
    ...
    { ND_PROTO_WHATSAPP_VIDEO, "WhatsAppVideo" },
...
const nd_ndpi_proto_t nd_ndpi_protos = {
    ...
    { NDPI_PROTOCOL_HANGOUT_DUO, ND_PROTO_GOOGLE_DUO },
    { NDPI_PROTOCOL_HANGOUT, ND_PROTO_GOOGLE_MEET },
